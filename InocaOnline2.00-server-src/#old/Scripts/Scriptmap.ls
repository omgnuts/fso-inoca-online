...
on scriptMap
 ...
 -- theMap.append( [ #movieID: "inomov", #scriptFileName: "fso.ls" ] )
...
theMap.append( [ #movieID: "inomov", #scriptFileName: "MaxLogonCounter.ls" ] )
...
on globalScriptList
  ...
  theList = [ "GlobalScripts.ls", "Assassins.ls", "Cauldron.ls", "Timers.ls", "games.ls", "quests.ls", "building.ls", "treasure.ls", "shop.ls", "npcs.ls", "books.ls", "Boss.ls", "Timeoutobjects.ls", "CharCreate", "GameEvents.ls", "CabCount.ls", "Antihack.ls", "Jail.ls", "BackupChar.ls", "Events.ls", "MaxLogonCounter.ls", "MapRestrictions.ls", "cleanFunctions.ls", "Marriage.ls", "CaptureFlag.ls" ]
