 ...
 ****************************************************************************/ 
BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(ClassMD5register, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(ClassMD5register, IMoaRegister, XTRA_VERSION_NUMBER)
		/*
		 * ---> insert additional interface(s) -->
		 */ 
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(caluMD5Class, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(caluMD5Class, IMoaMmXScript, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(caluMD5Class, IMoaInitFromDict, XTRA_VERSION_NUMBER)	
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(caluMD5Class, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
		/*
		 * ---> insert additional interface(s) -->
		 */ 
